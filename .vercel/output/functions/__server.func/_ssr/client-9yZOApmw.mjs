...
import { Jt as toKebabCase, m as isSafeUrlScheme, o as createFetch, qt as capitalizeFirstLetter } from "../_libs/@better-auth/core+[...].mjs";
import { n as defu } from "../_libs/defu.mjs";
import { a as getBaseURL, i as PACKAGE_VERSION, r as GENERIC_OAUTH_ERROR_CODES } from "./router-VAZZY4Db.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/client-9yZOApmw.js
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-transform duration-[var(--motion-quick)] ease-[var(--ease-smooth-out)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]", {
	variants: {
		variant: {
...
//#endregion
export { signOut as i, authClient as n, signIn as r, Button as t };
